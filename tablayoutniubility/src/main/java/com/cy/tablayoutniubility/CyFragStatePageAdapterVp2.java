 ...
 * @Description:
 * @Author: cy
 * @CreateDate: 2020/10/7 21:57
 * @UpdateUser:
 * @UpdateDate: 2020/10/7 21:57
 * @UpdateRemark:
 * @Version: 1.0
 */
public abstract class CyFragStatePageAdapterVp2 extends
    ...
    private CyFragStatePageAdapterVp2.FragmentMaxLifecycleEnforcer mFragmentMaxLifecycleEnforcer;
    ...
    public CyFragStatePageAdapterVp2(@NonNull FragmentManager fragmentManager,
    ...
    public void onAttachedToRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        mFragmentMaxLifecycleEnforcer = new CyFragStatePageAdapterVp2.FragmentMaxLifecycleEnforcer();
...
//        }
    ...
    class FragmentMaxLifecycleEnforcer {
        ...
        void register(@NonNull RecyclerView recyclerView) {
            ...
            mDataObserver = new CyFragStatePageAdapterVp2.DataSetChangeObserver() {
                @Override
