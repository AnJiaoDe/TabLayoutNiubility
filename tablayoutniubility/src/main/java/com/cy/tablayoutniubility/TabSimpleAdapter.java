...
// */
//
//public abstract class TabSimpleAdapter<T>  {
//
...
//     * @param list_bean
//     */
//    public TabSimpleAdapter<T> setList_bean(List<T> list_bean) {
...
//     * 删除相应position的数据Item
//     */
//    public TabSimpleAdapter<T> removeNoNotify(int position) {
...
//     */
//    public TabSimpleAdapter<T> remove(int position) {
...
//     * 添加一条数据item
//     */
//    public TabSimpleAdapter<T> addNoNotify(int position, T bean) {
...
//     * 添加一条数据item,并且notify
//     */
//    public TabSimpleAdapter<T> add(int position, T bean) {
...
//     * 添加一条数据item
//     */
//    public TabSimpleAdapter<T> addNoNotify(T bean) {
//        list_bean.add(bean);
//        return this;
//    }
//
...
//     * 添加一条数据item,并且notify
//     */
//    public TabSimpleAdapter<T> add(T bean) {
//        addNoNotify(bean);
...
//     */
//
//    public TabSimpleAdapter<T> addToTopNoNotify(T bean) {
...
//     */
//    public TabSimpleAdapter<T> addToTop(T bean) {
...
//     * 添加List
//     */
//    public TabSimpleAdapter<T> addNoNotify(List<T> beans) {
...
//     * 添加List,并且notify
//     */
//    public TabSimpleAdapter<T> add(List<T> beans) {
//        addNoNotify(beans);
...
//     */
//
//    public TabSimpleAdapter<T> clearAddNoNotify(List<T> beans) {
//        list_bean.clear();
//        list_bean.addAll(beans);
//        return this;
//    }
...
//     */
//
//    public TabSimpleAdapter<T> clearAddNoNotify(T bean) {
//        clearAdd(bean);
//        return this;
//    }
//
...
//     */
//
//    public TabSimpleAdapter<T> clearAdd(T bean) {
//        clearNoNotify();
//        add(bean);
//        notifyDataSetChanged();
//        return this;
...
//     */
//
//    public TabSimpleAdapter<T> clearAdd(List<T> beans) {
...
//     */
//
//    public TabSimpleAdapter<T> addToTopNoNotify(List<T> beans) {
...
//     */
//
//    public TabSimpleAdapter<T> addToTop(List<T> beans) {
...
//     * 清空list
//     */
//    public TabSimpleAdapter<T> clearNoNotify() {
//        list_bean.clear();
//        return this;
//    }
//
...
//     * 清空list
//     */
//    public TabSimpleAdapter<T> clear() {
//        list_bean.clear();
//        notifyDataSetChanged();
//        return this;
//    }
//
//
//    public TabSimpleAdapter<T> setNoNotify(int index, T bean) {
//        list_bean.set(index, bean);
//        return this;
//    }
//
//    public TabSimpleAdapter<T> set(int index, T bean) {
