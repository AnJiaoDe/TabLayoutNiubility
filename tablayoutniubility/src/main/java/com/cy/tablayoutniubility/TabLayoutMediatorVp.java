 ...
 * @Version:
 */
public class TabLayoutMediatorVp<T> {
    ...
    public TabLayoutMediatorVp(TabLayoutNiubility tabLayout, final ViewPager viewPager) {
    ...
    public TabAdapter<T> setAdapter(final FragmentPageAdapterVp<T> fragmentPageAdapter) {
        tabAdapter = new TabAdapter<T>() {
            ...
            public void onItemClick(TabViewHolder holder, int position, T bean) {
                ...
                position_selected_last = viewPager.getCurrentItem();
                    ...
                    if ((position == viewPager.getCurrentItem() - 1 || position == viewPager.getCurrentItem())) {
                        ...
                        if (viewHolder != null) {
                            ...
                            if (positionOffset != 0) {
                                ...
                                rvScrolledByVp = true;
                                //往右滑
                                if (position_selected_last < viewPager.getCurrentItem()) {
