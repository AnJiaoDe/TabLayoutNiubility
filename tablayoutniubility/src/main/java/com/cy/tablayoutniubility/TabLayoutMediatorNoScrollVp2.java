...
// * @Version:
// */
//public class TabLayoutMediatorNoScrollVp2<T,V extends IViewHolder> {
...
//
//    public TabLayoutMediatorNoScrollVp2(TabLayoutNoScroll tabLayout, final ViewPager2 viewPager2) {
//        this.tabLayout = tabLayout;
//        this.viewPager2 = viewPager2;
//    }
//
//    public TabNoScrollAdapter<T> setAdapter(final FragmentPageAdapterVp2<T,V> fragmentPageAdapter) {
//        tabAdapter = new TabNoScrollAdapter<T>(tabLayout.getContext()) {
//            @Override
//            public void bindDataToView(TabNoScrollViewHolder holder, int position, T bean, boolean isSelected) {
//                fragmentPageAdapter.bindDataToTab((V) holder, position, bean, isSelected);
//            }
//
//            @Override
...
////                RecyclerView.ViewHolder viewHolder = tabLayout.getTabNoScrollRecyclerView().findViewHolderForAdapterPosition(viewPager2.getCurrentItem());
////                if (viewHolder != null) {
////
...
////                 */
////                BaseViewHolder viewHolder = (BaseViewHolder) tabLayout.getTabNoScrollRecyclerView().findViewHolderForAdapterPosition(position);
////                if (viewHolder != null) {
////                    int width_half = (int) (viewHolder.itemView.getWidth() * 1f / 2);
////                    int left = viewHolder.itemView.getLeft();
////                    BaseViewHolder viewHolder_behind = (BaseViewHolder) tabLayout.getHorizontalRecyclerView().findViewHolderForAdapterPosition(position + 1);
////                    if (position == 0) {
...
////                    viewHolder = (BaseViewHolder) tabLayout.getHorizontalRecyclerView().findViewHolderForAdapterPosition(position);
...
//
//
//        viewPager2.setAdapter(fragmentPageAdapter);        tabLayout.getTabNoScrollView().setAdapter(tabAdapter);
//
//
//        return tabAdapter;
//    }
